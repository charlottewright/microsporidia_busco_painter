...
p <- ggplot(filtered_table) +
  geom_rect(aes(xmin=position-2e2, xmax=position+2e2, ymax=0, ymin =5, fill=assigned_chr)) +
  ...
  panel.background = element_rect(fill = "white", colour = "black"), panel.grid.major = element_blank(), 
